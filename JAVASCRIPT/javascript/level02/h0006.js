...
var divInfo = document.getElementById('txtInfo');
var divSave = document.getElementById('btnSave');
var btnLoad = document.getElementById('btnLoad');
var btnDel = document.getElementById('btnDel');
console.log(divInfo, divInfo, divSave, btnLoad, btnDel);
...
// 组员效果给组长检查
//<a href='level02/h0006.html'>本地储存和页面跳转</a>
// 最好将练习的链接也加进去