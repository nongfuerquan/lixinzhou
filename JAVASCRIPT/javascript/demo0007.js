...
console.log(a / b);
console.log(a % b);
//a mod b 整除余下的数 100除以3，最大值能是33，余数是1
console.log(a * a - b);
console.log(a * (a - b));
...
jisuan.addEventListener('click', function() {
  // 用shuzi01+shizi02的输入值放到jieguo里面去
  // 注意！！！文本框输入的值都是字符
  // 面计算机中字符的加法是拼接字符
...
donghua.addEventListener('click', function() {
  ...
  // setTmeout是延时执行代码，和setTnterval不一样的是，只会执行一次
  // 第一个参数是要执行的代码，第二个参数是延时的毫秒数
  setTimeout(function() {
    // 清空class的值，还原成默认状态
